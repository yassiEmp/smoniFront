...
export const blogPosts: BlogPost[] = [
  ...
  {
    slug: "jai-rate-mon-permis-comment-le-repasser-rapidement-2026",
    title: "J'ai raté mon permis : comment le repasser rapidement en 2026 ?",
    subtitle: "Délai légal, plateforme RDV-Permis et stage accéléré : le guide complet pour repasser votre permis B vite après un échec, avec un plan d'action semaine par semaine.",
    excerpt: "Vous venez d'échouer à l'examen pratique ? Près d'un candidat sur deux est dans ce cas en France. Le délai légal de repasse est de 2 jours seulement, mais les délais constatés vont de 4 semaines en province à 5 mois en Île-de-France. Ce guide décrypte la mécanique RDV-Permis, donne 6 leviers concrets pour décrocher une nouvelle date, démystifie le stage accéléré en 15 jours et propose un plan d'action semaine par semaine pour transformer l'échec en repasse rapide.",
    category: "Examen",
    date: "22 Mai 2026",
    readingTime: "13 min",
    // TODO: replace with final hero image once generated from image-prompts.json
    image: "https://images.unsplash.com/photo-1502877338535-766e1452684a?auto=format&fit=crop&q=80&w=2000",
    author: { name: "Arike Bello", avatar: "AB" },
    tags: ["Permis B", "Échec permis", "Repasse permis", "Délai examen", "RDV-Permis", "Stage accéléré", "Auto-école Vincennes"],
    sections: [
      {
        title: "Vous venez de rater votre permis : que faire dans les 48 heures ?",
        iconName: "AlertTriangle",
        content: "Si vous lisez ces lignes le téléphone encore chaud après un appel décevant ou les yeux rivés sur un mail qui commence par « Nous regrettons », respirez. Vous n'êtes pas seul, et statistiquement, vous êtes même dans la majorité. Selon l'enquête de référence menée par UFC-Que Choisir sur le marché du permis de conduire, le taux de réussite à l'épreuve pratique en première présentation oscille autour de 57 % en France. Autrement dit, près d'un candidat sur deux échoue à sa première tentative. Ce chiffre n'est pas un échec personnel, c'est un fait statistique. Mais ce que cette même étude ne dit pas, c'est que la qualité de votre repasse dépend presque entièrement de ce que vous faites dans les 48 heures qui suivent l'annonce du résultat.",
        secondContent: "Les 48 heures post-échec sont en réalité une fenêtre critique. C'est dans cette courte période que se joue votre capacité à enchaîner rapidement, ou à laisser dériver le calendrier de plusieurs mois. La plupart des candidats commettent la même erreur : ils encaissent le coup, prennent quelques jours pour digérer, puis rappellent l'auto-école une semaine plus tard. Cette semaine perdue se traduit presque toujours par six à douze semaines de délai supplémentaire en région parisienne et sur les grandes métropoles. Ce guide va vous donner une méthode claire pour transformer ce moment difficile en passage rapide vers une nouvelle date d'examen — pas dans trois mois, mais idéalement sous trois à six semaines.",
        bullets: [
          "Récupérer votre bilan d'examen détaillé auprès de votre formateur dans les 24 heures pour identifier les points qui ont fait basculer la note.",
          "Confirmer votre résultat officiel en ligne sous 48 heures via le site dédié de la Sécurité Routière (résultats du permis).",
          "Reprendre contact avec votre auto-école dans les 48 heures pour positionner une nouvelle place sur RDV-Permis avant qu'elle ne soit captée par un autre candidat.",
          "Bloquer une à deux heures de conduite dans la semaine pour ne pas perdre les réflexes acquis.",
        ],
      },
      {
        title: "Le délai légal réel pour repasser : 2 jours, et puis quoi ?",
        iconName: "Clock",
        content: "Commençons par le seul délai officiellement fixé par l'État, et qui surprend toujours les candidats. Le site Service-Public.gouv.fr, qui fait foi sur ce point, est très clair : en cas d'échec à une épreuve du permis de conduire, vous ne pouvez pas vous présenter à l'épreuve suivante avant un délai de deux jours, calculé de date à date. Deux jours. Pas deux semaines, pas un mois. Sur le plan strictement légal, vous pourriez théoriquement repasser dès le lundi suivant un échec un vendredi. Cette information seule est libératrice pour beaucoup de candidats convaincus qu'ils devaient attendre des semaines pour réessayer.",
        secondContent: "Mais le délai légal n'est qu'un plancher théorique. Dans la réalité opérationnelle de 2026, le délai effectif est dicté par deux contraintes : la disponibilité des places d'examen sur la plateforme RDV-Permis, et la capacité de votre auto-école à vous repositionner dessus. C'est cette double contrainte qui explique les écarts régionaux gigantesques constatés aujourd'hui en France. En Île-de-France et dans les grandes métropoles, le délai constaté entre échec et nouvelle présentation oscille entre trois et cinq mois sans démarche active de votre part. En province et dans les zones rurales, la même attente tombe à quatre à huit semaines. Comprendre ce mécanisme est la clé pour activer les bons leviers et raccourcir drastiquement cette attente.",
        bullets: [
          "Délai légal minimum : 2 jours date à date (source Service-Public.gouv.fr).",
          "Délai constaté Paris / Île-de-France : 3 à 5 mois en moyenne sans démarche active.",
          "Délai constaté grandes métropoles (Lyon, Marseille, Bordeaux) : 2 à 4 mois.",
          "Délai constaté villes moyennes et province : 4 à 8 semaines.",
          "Délai constaté en stage de repasse accéléré dédié : 15 à 30 jours selon les régions.",
        ],
      },
      {
        title: "Comprendre RDV-Permis : pourquoi les délais varient autant en 2026",
        iconName: "Calendar",
        content: "Pour repasser vite, il faut d'abord comprendre comment fonctionne la mécanique d'attribution des places d'examen. Depuis le déploiement national de la plateforme RDV-Permis, gérée par le Ministère de l'Intérieur via la Sécurité Routière, l'allocation des créneaux d'examen pratique n'est plus tenue par les préfectures mais par un système numérique national. La règle est simple en apparence et terrible en pratique : ce n'est pas vous qui réservez votre place d'examen, c'est votre école de conduite agréée. Le candidat choisit son centre, sa date et son créneau en accord avec son formateur, mais l'opération de réservation passe par les comptes professionnels que les écoles de conduite détiennent sur la plateforme.",
        secondContent: "Cette mécanique a deux conséquences directes pour vous, candidat venant d'échouer. D'abord, votre vitesse de repasse est conditionnée par la fréquence à laquelle votre auto-école se connecte à RDV-Permis pour récupérer des créneaux libérés. Les écoles les plus actives consultent la plateforme plusieurs fois par jour, captent les annulations de dernière minute et les ouvertures matinales. Les écoles passives attendent les ouvertures hebdomadaires de places et perdent systématiquement face aux concurrents. Ensuite, votre vitesse dépend du nombre de candidats déjà en file d'attente chez votre école. Si vous êtes treizième sur la liste interne, vous repasserez après douze autres élèves, quelle que soit la disponibilité réelle des places côté plateforme.",
        bullets: [
          "RDV-Permis est la plateforme nationale officielle, gérée par la Sécurité Routière.",
          "Les places sont réservées par les écoles, pas directement par les candidats.",
          "La fréquence de connexion de votre école à la plateforme conditionne votre vitesse de repasse.",
          "Les annulations de dernière minute libèrent en permanence des créneaux, mais elles partent en quelques minutes.",
          "Votre rang dans la file d'attente interne de l'école compte autant que la disponibilité côté plateforme.",
        ],
        tip: {
          label: "Question à poser",
          text: "Demandez explicitement à votre auto-école combien de fois par semaine elle se connecte à RDV-Permis pour récupérer des places, et combien de candidats sont actuellement en attente de repasse avant vous. Si la réponse est floue ou si vous êtes au-delà de la dixième position, vous savez déjà que la repasse rapide ne se jouera pas chez ce prestataire.",
        },
      },
      {
        title: "Décrocher une nouvelle date rapidement : 6 leviers concrets",
        iconName: "Target",
        content: "Une fois la mécanique de RDV-Permis comprise, il existe six leviers concrets qui peuvent transformer une attente de quatre mois en une repasse sous quatre à six semaines, même en région parisienne. Aucun de ces leviers n'est miraculeux pris isolément, mais combinés, ils suffisent presque toujours à décaler la courbe de plusieurs semaines. Voici les sept actions que les candidats qui repassent le plus vite mettent systématiquement en place.",
        secondContent: "Le levier le plus sous-estimé reste l'élasticité géographique. Beaucoup de candidats franciliens s'entêtent à repasser dans leur centre d'examen initial alors qu'un centre situé en grande couronne ou dans un département limitrophe pourrait leur ouvrir une place sous quinze jours. Cette flexibilité coûte une heure de trajet le jour J, mais peut faire gagner trois mois sur le calendrier global. Si vous cherchez à structurer ce parcours avec un accompagnement spécifique, l'équipe peut faire un point sur les centres ouverts dans votre périmètre via une prise de contact rapide.",
        bullets: [
          "Cibler les créneaux annulés : la plateforme RDV-Permis libère des places en continu quand des candidats se désinscrivent ou tombent malades. Demandez à votre école de vous inscrire sur sa liste prioritaire d'attente pour les annulations.",
          "Élargir géographiquement votre zone d'examen : un centre d'examen à 30 ou 40 kilomètres de chez vous peut avoir un délai de réservation trois fois plus court qu'un centre saturé. Acceptez de vous déplacer pour gagner deux mois.",
          "Privilégier les créneaux peu demandés : les lundis matin très tôt, les samedis et les semaines creuses (vacances scolaires hors été) sont systématiquement moins prisés et donc plus disponibles.",
          "Changer temporairement d'école pour le passage : certaines auto-écoles spécialisées dans la repasse rapide réservent un quota de places à leurs élèves externes en candidat libre. Le coût supplémentaire est généralement compensé par le temps gagné.",
          "Activer le candidat libre via la plateforme La Poste : depuis la réforme, vous pouvez vous présenter en candidat libre via un partenariat avec La Poste, ce qui ouvre des créneaux indépendants du réseau classique des auto-écoles.",
          "Choisir une auto-école avec un faible taux d'élèves en attente : avant de signer, exigez le chiffre exact du nombre de candidats actuellement en file de repasse. Une école à 3 candidats en attente vous repositionnera quatre fois plus vite qu'une école à 12.",
        ],
      },
      {
        title: "Stage de repasse accéléré : passer en 15 jours, mythe ou réalité ?",
        iconName: "Zap",
        content: "Une des recherches les plus fréquentes des candidats après un échec est « repasser son permis en 15 jours ». Est-ce réaliste, et à quelles conditions ? La réponse honnête : oui, mais sous conditions strictes. Le stage de repasse accéléré, proposé par un nombre croissant d'auto-écoles spécialisées, repose sur un principe simple : concentrer en deux semaines vingt à trente heures de conduite supplémentaires couplées à une place d'examen pré-réservée, généralement dans un département périphérique où les délais RDV-Permis sont plus courts.",
        secondContent: "Ce format suppose néanmoins que vous puissiez bloquer votre emploi du temps à temps plein pendant la durée du stage. Pour un actif salarié, cela suppose une période de congés ou un arrangement employeur. Pour un étudiant en cours, cela suppose des vacances scolaires. Sans cette disponibilité totale, le stage perd son efficacité et coûte cher pour rien. Côté budget, comptez entre 800 et 1 600 euros pour un stage de repasse complet selon la région, l'auto-école et le format choisi. Pour une analyse détaillée des coûts post-échec et des aides mobilisables, vous pouvez consulter notre guide dédié sur le prix du permis B après un premier échec.",
        bullets: [
          "Format type d'un stage accéléré : 20 à 30 heures de conduite sur 10 à 15 jours, hors week-ends.",
          "Examen pratique pré-réservé à la fin du stage, généralement en grande couronne ou en province.",
          "Budget complet : 800 à 1 600 € selon région et formule (héro pédago, plateau, examen blanc inclus).",
          "Profil idéal : candidat ayant échoué sur 1 à 2 critères seulement (créneaux, priorités), pas sur des fondamentaux de conduite.",
          "Profil à éviter : candidat ayant cumulé plusieurs erreurs majeures — un stage accéléré ne corrige pas un défaut de base, il consolide des acquis fragiles.",
        ],
        tip: {
          label: "Réalisme",
          text: "Le stage accéléré marche très bien pour les candidats à 80 % du niveau attendu qui ont craqué sur un point précis. Il ne marche pas pour rattraper un retard pédagogique de fond. Soyez honnête avec vous-même sur les raisons de votre échec avant d'investir 1 200 euros dans un format intensif.",
        },
      },
      {
        title: "Combien d'heures de conduite supplémentaires prévoir avant la repasse ?",
        iconName: "Activity",
        content: "C'est l'autre question récurrente : « combien d'heures dois-je reprendre avant de retenter l'examen ? ». L'étude UFC-Que Choisir sur le permis montre déjà qu'en France, le candidat moyen consomme environ 35 heures de conduite au total, soit 15 heures de plus que le minimum légal de 20 heures. Après un échec, ce volume augmente encore. Les bonnes pratiques observées chez les écoles à haut taux de réussite convergent vers une fourchette de cinq à dix heures supplémentaires entre l'échec et la nouvelle présentation.",
        secondContent: "Ce volume n'est pas arbitraire. Il correspond au temps minimum nécessaire pour retravailler les points faibles identifiés sur la grille d'évaluation de l'examen, sans pour autant créer une fatigue contre-productive. Dix heures de conduite mal ciblées valent moins que quatre heures focalisées sur le ou les deux points qui ont coûté votre note. C'est pourquoi le bilan détaillé du formateur, récupéré dans les 48 heures post-échec, est si critique : il transforme un volume horaire en plan pédagogique ciblé. Pour un accompagnement structuré et un parcours sur mesure adapté à votre profil de repasse, l'équipe Smoni peut établir un diagnostic en cours d'évaluation avant de fixer le volume horaire.",
        bullets: [
          "Volume minimum recommandé : 4 à 6 heures de conduite ciblées entre l'échec et la repasse.",
          "Volume médian constaté : 8 à 10 heures pour les candidats ayant échoué sur plusieurs critères.",
          "Volume maximum utile : 15 heures (au-delà, l'apprentissage plateau et le bénéfice marginal s'effondre).",
          "Format à privilégier : séances de 2 heures consécutives plutôt que des heures isolées (meilleure consolidation des acquis).",
        ],
      },
      {
        title: "Le piège du planning : les erreurs qui font perdre 3 mois",
        iconName: "ShieldAlert",
        content: "Au-delà des bonnes pratiques, il existe une série d'erreurs très fréquentes qui transforment mécaniquement une attente raisonnable en attente longue. Ces erreurs ne sont pas commises par paresse, mais par méconnaissance du fonctionnement actuel du système. Les voici, par ordre décroissant d'impact sur votre calendrier.",
        secondContent: "Ces erreurs ont un point commun : elles sont toutes prises individuellement et émotionnellement, sans visibilité sur l'impact systémique. Le bon réflexe est inverse : poser à plat son calendrier dès le lendemain de l'échec, identifier les leviers activables, prendre les décisions difficiles tôt (changement de centre, reprise d'heures, voire changement d'école si nécessaire) plutôt que de subir le calendrier. Trois jours de réflexion structurée valent trois mois d'attente passive.",
        bullets: [
          "Attendre une semaine avant de rappeler l'auto-école : pendant que vous digérez, votre place dans la file interne se reconstitue derrière de nouveaux candidats arrivants. Vous perdez en moyenne 4 à 6 semaines.",
          "Refuser un centre d'examen périphérique : tenir absolument à passer dans son centre de quartier alors qu'un centre à 30 km a un délai trois fois plus court coûte typiquement 8 à 12 semaines.",
          "Ne pas demander le bilan d'examen détaillé : sans ce diagnostic, le travail de reprise est aveugle et inefficace, ce qui se traduit par un nouvel échec et un cycle supplémentaire de 2 à 4 mois.",
          "Surinvestir en heures sans plan : prendre quinze heures de conduite « pour être sûr » sans cibler les points faibles fatigue le candidat et baisse le taux de réussite.",
          "Reporter pour cause de stress : repousser sa repasse parce qu'on ne se sent pas prêt psychologiquement alors qu'on est techniquement au niveau prolonge le stress au lieu de le résoudre.",
        ],
      },
      {
        title: "Votre plan d'action concret, semaine par semaine",
        iconName: "ClipboardCheck",
        content: "Voici le plan d'action complet qu'utilisent les candidats qui réussissent leur repasse en quatre à six semaines. Ce n'est pas un modèle théorique, mais la séquence opérationnelle observée chez les profils qui transforment leur échec en réussite rapide. Adaptez-le à votre situation, mais respectez les jalons critiques : ils sont chacun à l'origine d'une grosse partie du gain de temps total.",
        secondContent: "La règle d'or de ce plan d'action est simple : la vitesse de votre repasse dépend infiniment plus de la qualité de votre première semaine post-échec que du nombre d'heures supplémentaires que vous prendrez. Quarante-huit heures bien utilisées valent quatre semaines d'attente passive. Vous n'êtes pas seul à passer par cette étape : des milliers de candidats français vivent exactement la même expérience chaque mois, et la grande majorité décroche son permis lors de la deuxième présentation. Pour structurer votre repasse avec un accompagnement personnalisé, voir les heures de conduite ciblée disponibles ou faire un point sur les délais réels dans votre secteur, vous pouvez prendre contact avec l'équipe en quelques minutes via le formulaire de contact.",
        table: {
          headers: ["Période", "Actions clés", "Résultat attendu"],
          rows: [
            ["Jours 1 à 2 (48h post-échec)", "Récupérer le bilan d'examen détaillé. Vérifier résultat officiel en ligne. Rappeler l'auto-école pour positionner une demande de repasse sur RDV-Permis. Demander le rang dans la file interne.", "Position sécurisée sur la liste interne, points faibles identifiés."],
            ["Semaine 1", "Reprendre 2 heures de conduite ciblées sur les points faibles. Élargir géographiquement la zone d'examen acceptée. Activer la liste prioritaire annulations.", "Pédagogie de reprise lancée, surface de places élargie."],
            ["Semaines 2 à 3", "4 à 6 heures supplémentaires de conduite focalisées. Surveiller les ouvertures RDV-Permis hebdomadaires (typiquement mardi matin). Bloquer un examen blanc avec un formateur.", "Niveau consolidé, validation pédagogique."],
            ["Semaines 4 à 6", "Repasse de l'examen pratique. Préparation mentale légère (sommeil, alimentation). Pas de nouvelle heure dans les 48h précédant l'examen.", "Présentation à l'examen dans des conditions optimales."],
            ["Si stage accéléré choisi", "Stage de 10 à 15 jours en continu avec examen pré-réservé en fin de stage. Format intensif réservé aux profils à 80 % du niveau.", "Repasse possible sous 15 à 30 jours selon disponibilités."],
          ],
        },
        quote: {
          text: "Le permis n'est pas un examen qu'on rate ; c'est un examen qu'on prépare deux fois quand on a la chance de le rater une fois. La deuxième présentation est presque toujours la bonne.",
          author: "Principe pédagogique partagé par les écoles à fort taux de réussite (synthèse Smoni)",
        },
      },
    ],
  }
