...
import Service from '@assets/dashboard-moniteur/service.svg'
import Code from '@assets/dashboard-moniteur/code.svg'
import Admin from '@assets/dashboard-admin/admins.svg'
...
// import NotificationPopover from '@/components/moniteur/notification/NotifMonitorPopover'
  ...
  return (
    ...
    <div className="max-h-[calc(100vh-120px)] overflow-y-auto">
      <nav className='flex flex-col space-y-[16px] px-[32px] py-[24px]'>
        {NavItem.map((item, index) => (
          <Link 
            ...
            className='flex items-center gap-[10px] py-[8px] pl-[12px] pr-[16px]'
          >
      ...
      <div className='flex items-center w-full space-x-[4px] py-4 pl-[32px] relative' ref={dropdownRef}>
        ...
        {showDropdown && (
          <div className="absolute left-[32px] top-[calc(100%+8px)] pb-2 w-48 bg-white rounded-md shadow-lg py-1 border border-gray-100 z-50">
            <button
              onClick={() => {
                setShowDropdown(false)
                setIsOpen(false)
